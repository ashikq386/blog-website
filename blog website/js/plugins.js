...
function(a, b) {
    ...
    return i.Item = f, i.prototype._create = function() {
        ...
        var a = this.packer;
        this.options.isHorizontal ? (a.width = Number.POSITIVE_INFINITY, a.height = this.size.innerHeight + this.gutter, a.sortDirection = "rightwardTopToBottom") : (a.width = this.size.innerWidth + this.gutter, a.height = Number.POSITIVE_INFINITY, a.sortDirection = "downwardLeftToRight"),
        a.reset(),
        this.maxY = 0,
        this.maxX = 0
            ...
            if (a && I in i && delete i[I], i.attributes) {
                ...
                if (s.length) {
                    var k,
                        w,
                        x;
                    !a && I in i ? (x = i[I], k = st[x].styleAttr, w = st[x].classAttr) : (x = i[I] = Gt++, k = i.style.cssText, w = Ht(i)),
                    st[x] = {
                        element: i,
                        styleAttr: k,
                        classAttr: w,
    ...
    var j = function() {
        ...
        J = function() {
            ...
            var e,
                ...
                o = Nt();
            if (dt)
                o >= dt.endTime ? (n = dt.targetTop, e = dt.done, dt = r) : (t = dt.easing((o - dt.startTime) / dt.duration), n = 0 | dt.startTop + t * dt.topDiff),
                lt.setScrollTop(n, !0);
            else if (!yt) {
        ...
        var r = {
                init: function(i) {
                    ...
                    return t.each(t(s).find('meta[name="description"]'), function(e, s) {
                        ...
                        "undefined" != typeof u && (i.addClass("share-affix"), -1 != u.indexOf("right") ? (i.css("left", "auto"), i.css("right", "0px"), -1 != u.indexOf("center") && i.css("top", "40%")) : -1 != u.indexOf("left center") && i.css("top", "40%"), -1 != u.indexOf("bottom") && (i.css("bottom", "0px"), i.css("top", "auto"), -1 != u.indexOf("center") && i.css("left", "40%"))),
    ...
    t = function(t, i) {
        ...
        return a = {}, a.canvas = {}, a.mouse = {}, a.particles = [], a.isAnimated = !1, a.initialize = function(e, t) {
            ...
            return a = {}, a.canvas = {}, a.vector = {}, a.initialize = function(t, n) {
                ...
                do a.vector.x = n.getRandNumber(-a.params.speed / 60, a.params.speed / 60, !1),
